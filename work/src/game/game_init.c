...
/*   Updated: 2025/10/21 15:45:19 by nkief            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int window_init(t_cub *cub)
{
    ...
    if (init_textures(cub) < 0)
    {
        ...
        // free_cub(&cub); // TODO: Implementer free_cub
        return 0;
    }
    /**/
    /* Charger les textures HUD */
    if (!load_hud_textures(cub))
    {
        ft_putstr_fd("Error: failed to load HUD textures\n", 2);
        return 0;
    }
    /**/
